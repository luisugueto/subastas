...
<body>
    ...
    <a href="index-2.html#0" class="scrollToTop"><i class="fas fa-angle-up"></i></a>
            ...
            <div class="container">
                <div class="header-top-wrapper">
                    <ul class="customer-support">
                        <li>
                            <a href="index-2.html#0" class="mr-3"><i class="fas fa-phone-alt"></i><span class="ml-2 d-none d-sm-inline-block">Customer Support</span></a>
                        </li>
                        <li>
                    ...
                    <ul class="cart-button-area">
                        <li>
                            <a href="index-2.html#0" class="cart-button"><i class="flaticon-shopping-basket"></i><span class="amount">08</span></a>
                        </li>                        
                        <li>
            ...
            <div class="container">
                <div class="header-wrapper">
                    ...
                    <ul class="menu ml-auto">
                        ...
                        <li>
                            <a href="index-2.html#0">Pages</a>
                            <ul class="submenu">
                                <li>
                                    <a href="index-2.html#0">Product</a>
                                    <ul class="submenu">
                                        <li>
                                ...
                                <li>
                                    <a href="index-2.html#0">My Account</a>
                                    <ul class="submenu">
                                        <li>
                                ...
                                <li>
                                    <a href="index-2.html#0">Dashboard</a>
                                    <ul class="submenu">
                                        <li>
                    ...
                    <div class="search-bar d-md-none">
                        <a href="index-2.html#0"><i class="fas fa-search"></i></a>
                    </div>
        ...
        <div class="bottom-content">
            <div class="cart-products">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="index-2.html#0"><img src="assets/images/shop/shop01.jpg" alt="shop"></a>
                    </div>
                    <div class="content">
                        <h4 class="title"><a href="index-2.html#0">Color Pencil</a></h4>
                        <div class="price"><span class="pprice">$80.00</span> <del class="dprice">$120.00</del></div>
                        <a href="index-2.html#" class="remove-cart">Remove</a>
                    </div>
                </div>
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="index-2.html#0"><img src="assets/images/shop/shop02.jpg" alt="shop"></a>
                    </div>
                    <div class="content">
                        <h4 class="title"><a href="index-2.html#0">Water Pot</a></h4>
                        <div class="price"><span class="pprice">$80.00</span> <del class="dprice">$120.00</del></div>
                        <a href="index-2.html#" class="remove-cart">Remove</a>
                    </div>
                </div>
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="index-2.html#0"><img src="assets/images/shop/shop03.jpg" alt="shop"></a>
                    </div>
                    <div class="content">
                        <h4 class="title"><a href="index-2.html#0">Art Paper</a></h4>
                        <div class="price"><span class="pprice">$80.00</span> <del class="dprice">$120.00</del></div>
                        <a href="index-2.html#" class="remove-cart">Remove</a>
                    </div>
                </div>
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="index-2.html#0"><img src="assets/images/shop/shop04.jpg" alt="shop"></a>
                    </div>
                    <div class="content">
                        <h4 class="title"><a href="index-2.html#0">Stop Watch</a></h4>
                        <div class="price"><span class="pprice">$80.00</span> <del class="dprice">$120.00</del></div>
                        <a href="index-2.html#" class="remove-cart">Remove</a>
                    </div>
                </div>
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="index-2.html#0"><img src="assets/images/shop/shop05.jpg" alt="shop"></a>
                    </div>
                    <div class="content">
                        <h4 class="title"><a href="index-2.html#0">Comics Book</a></h4>
                        <div class="price"><span class="pprice">$80.00</span> <del class="dprice">$120.00</del></div>
                        <a href="index-2.html#" class="remove-cart">Remove</a>
                    </div>
                </div>
                <div class="btn-wrapper text-center">
                    <a href="index-2.html#0" class="custom-button"><span>Checkout</span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center justify-content-between align-items-center">
                <div class="col-lg-6 col-xl-6">
                    <div class="banner-content cl-white">
                        ...
                        <a href="index-2.html#0" class="custom-button yellow btn-large">Get Started</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="section-header-2 mb-4">
                ...
                <div class="slider-nav">
                    <a href="index-2.html#0" class="bro-prev"><i class="flaticon-left-arrow"></i></a>
                    <a href="index-2.html#0" class="bro-next active"><i class="flaticon-right-arrow"></i></a>
                </div>
            </div>
            <div class="m--15">
                <div class="browse-slider owl-theme owl-carousel">
                    <a href="index-2.html#0" class="browse-item">
    ...
    <section class="feature-auction-section padding-bottom padding-top bg_img" data-background="./assets/images/auction/featured/featured-bg-1.jpg">
        <div class="container">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            ...
                            <a href="index-2.html#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="index-2.html#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                            ...
                            <div class="text-center">
                                <a href="index-2.html#0" class="custom-button">Submit a bid</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="load-wrapper">
                <a href="index-2.html#0" class="normal-button">See All Auction</a>
            </div>
        </div>
    </section>
                        ...
                        <div class="auction-inner">
                            ...
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="index-2.html#0">Apple Macbook Pro Laptop</a>
                                    </h6>
                                    <div class="list-area">
                ...
                <div class="client-slider owl-theme owl-carousel">
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            ...
                            <div class="content">
                                <h6 class="title"><a href="index-2.html#0">Alexis Moore</a></h6>
                                <div class="ratings">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            ...
                            <div class="content">
                                <h6 class="title"><a href="index-2.html#0">Darin Griffin</a></h6>
                                <div class="ratings">
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            ...
                            <div class="content">
                                <h6 class="title"><a href="index-2.html#0">Tom Powell</a></h6>
                                <div class="ratings">
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                                    <span><i class="fas fa-star"></i></span>
                ...
                <div class="row mb--60">
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-links">
                            ...
                            <ul class="links-list">
                                <li>
                                    <a href="index-2.html#0">Ending Now</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Vehicles</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Watches</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Electronics</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Real Estate</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Jewelry</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Art</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Sports & Outdoor</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-links">
                            ...
                            <ul class="links-list">
                                <li>
                                    <a href="index-2.html#0">About Sbidu</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Help</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Affiliates</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Jobs</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Press</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Our blog</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Collectors' portal</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-links">
                            ...
                            <ul class="links-list">
                                <li>
                                    <a href="index-2.html#0">Your Account</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Safe and Secure</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Shipping Information</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Contact Us</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0">Help & FAQ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                <li>
                                    <a href="index-2.html#0"><i class="fas fa-phone-alt"></i>(646) 663-4575</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fas fa-blender-phone"></i>(646) 968-0608</a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="87efe2ebf7c7e2e9e0e8f3efe2eae2a9e4e8ea">[email&#160;protected]</span></a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fas fa-location-arrow"></i>1201 Broadway Suite</a>
                                </li>
                            </ul>
                            <ul class="social-icons">
                                <li>
                                    <a href="index-2.html#0" class="active"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fab fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fab fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="index-2.html#0"><i class="fab fa-linkedin-in"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="copyright-area">
                    <div class="footer-bottom-wrapper">
                        ...
                        <ul class="gateway-area">
                            <li>
                                <a href="index-2.html#0"><img src="assets/images/footer/paypal.png" alt="footer"></a>
                            </li>
                            <li>
                                <a href="index-2.html#0"><img src="assets/images/footer/visa.png" alt="footer"></a>
                            </li>
                            <li>
                                <a href="index-2.html#0"><img src="assets/images/footer/discover.png" alt="footer"></a>
                            </li>
                            <li>
                                <a href="index-2.html#0"><img src="assets/images/footer/mastercard.png" alt="footer"></a>
                            </li>
                        </ul>
                        <div class="copyright"><p>&copy; Copyright 2021 | <a href="index-2.html#0">Sbidu</a> By <a href="index-2.html#0">Uiaxis</a></p></div>
                    </div>
                </div>
            </div>
        </div>
